...
const FILE_EXPLORER_FOLDER_LABELS = Object.freeze({
  ...
  X_GES: OTHER_CHARACTER_DISPLAY_NAMES.GES,
  Xixi_deleted: "西西｜已删除",
  browser_cache: "浏览器缓存",
  K_BACKUP: "K备份"
});
...
const FILE_EXPLORER_FILE_LABELS = Object.freeze({
  ...
  "husband_chat.txt": "丈夫聊天.txt",
  "staff_group_notice.txt": "工作群通知.txt",
  "rumor_comment_archive.txt": "谣言评论归档.txt",
  "friend_chat_enseo.txt": "好友聊天_恩瑟.txt",
  "birthday_0318.jpg": "生日照片_0318.jpg",
  "bnh_with_jyb_profile.png": "白娜熙账号主页.png",
  "1216_clip_edited.mp4": "1216裁切片段_5秒.mp4",
  "1216_clip_full_cache.mp4": "1216完整缓存_18秒.mp4",
  "post_edit_history.txt": "动态编辑记录.txt",
  "camera_strap_match.jpg": "相机挂绳匹配.jpg",
  "dm_question_archive.txt": "私信追问归档.txt",
  "notes_1216.txt": "1216个人备忘.txt",
  "exit_map_1216.png": "1216出口动线图.png",
  "bnh_watchlist.txt": "白娜熙观察记录.txt",
  "crop_manifest.json": "裁切清单.json",
  "unsent_to_jyb.txt": "未发送给姜艺彬.txt",
  "xixi_exchange_fragment.txt": "西西交换残片.txt",
  "klog_notes.txt": "K_Log观察记录.txt",
  "bnh_not_ges_note.txt": "她在盯着白娜熙.txt",
  ...
  "early_anger_draft.txt": "早期愤怒草稿.txt",
  "d_crosscheck.txt": "尹书璟交叉核验.txt",
  "ghost_material_log.txt": "老鬼材料记录.txt",
  "xixi_unsent_to_klog.txt": "未发送给K_Log.txt",
  "account_delete_reason.txt": "销号原因备忘.txt",
